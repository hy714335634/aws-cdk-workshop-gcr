...
class CfnAssociation(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ssm.CfnAssociation"):
    ...
    def automation_target_parameter_name(self, value: typing.Optional[str]):
    ...
    def compliance_severity(self, value: typing.Optional[str]):
    ...
    def max_concurrency(self, value: typing.Optional[str]):
    ...
    @max_errors.setter
    def max_errors(self, value: typing.Optional[str]):
    ...
    def sync_compliance(self, value: typing.Optional[str]):
    ...
    def wait_for_success_timeout_seconds(self, value: typing.Optional[jsii.Number]):
...
class CfnParameter(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ssm.CfnParameter"):
    ...
    @data_type.setter
    def data_type(self, value: typing.Optional[str]):
